...
def game():
	...
	while True:
		...
		if pilihan in kalah:
			print(f"\n");proccess()
			print('\033[3A');Console().print(Panel('[white]'+"kakak memilih "+pesan+" dan simi memilih "+com+" kakak KALAH >_<\n", style='purple'), justify='left')
		elif pilihan in menang:
			print(f"\n");proccess()
			print('\033[3A');Console().print(Panel('[white]'+"kakak memilih "+pesan+" dan simi memilih "+com+" kakak MENANG ^_^\n", style='purple'), justify='left')
